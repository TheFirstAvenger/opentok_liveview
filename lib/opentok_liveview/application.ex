defmodule OpentokLiveview.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      # {OpentokLiveview.Worker, arg}
    ]

    # See https://hexdocs.pm/elixir/Supervisor.html
    # for other strategies and supported options
    opts = [strategy: :one_for_one, name: OpentokLiveview.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    OpentokLiveviewWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
